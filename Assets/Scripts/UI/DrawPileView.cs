...
/// <summary>
/// Nút rút bài từ draw pile.
/// Khi rút được lá chơi được → hiện popup "Play this card?" với countdown.
/// </summary>
public class DrawPileView : MonoBehaviour
{
    ...
    private CardGameObject pendingCard;
    ...
    private void OnEnable()
    {
        ...
        GameEvents.OnDeckCountChanged += HandleDeckCountChanged;
    }
    ...
    private void HandleCardDrawn(CardGameObject card, bool isPlayable)
    {
